...
> uv run pytest              # 212 tests, fully offline
> ```
>
...
> | Architecture decisions + alternatives | [`DECISIONS.md`](DECISIONS.md) — 20 chronological D-entries with rationale and pushback |
...
> | Tests (212 passing, fully offline) | `uv run pytest` |
