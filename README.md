...
> uv run pytest              # 336 tests, fully offline
> ```
>
...
> | Architecture decisions + alternatives | [`DECISIONS.md`](DECISIONS.md) — 24 chronological D-entries with rationale and pushback |
...
> | Tests (336 passing, fully offline) | `uv run pytest` |
