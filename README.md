...
> uv run pytest              # 193 tests, fully offline
> ```
>
...
> | Architecture decisions + alternatives | [`DECISIONS.md`](DECISIONS.md) — 19 chronological D-entries with rationale and pushback |
...
> | Tests (193 passing, fully offline) | `uv run pytest` |
