...
from cpg_reconciler.allocation import Classifier, FTPCalculator
...
from cpg_reconciler.mapping.hooks import ConfidenceHook
...
from cpg_reconciler.mapping.resolver import DEFAULT_HANDLERS, StratumHandler
...
def analyze_week_fulfillment(
    *,
    ...
    _reranker = None
    if llm_client is not None:
        from cpg_reconciler.llm.reranker import apply_rerank, rerank_mapping, should_rerank
