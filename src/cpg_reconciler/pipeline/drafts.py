...
from cpg_reconciler.canonical import RetailerCode
from cpg_reconciler.erp import Client, ERPHTTPError, OrderDraftLine, OrderDraftRequest
from cpg_reconciler.erp.models import Customer, Product, Warehouse
from cpg_reconciler.pipeline.analyze import AnalysisResult, customer_for_retailer
    ...
    *,
    ...
    for c in result.classifications:
        ...
        request = OrderDraftRequest(
            ...
            notes=f"cpg-reconciler auto-draft for {retailer} {iso_week}",
        )
        try:
