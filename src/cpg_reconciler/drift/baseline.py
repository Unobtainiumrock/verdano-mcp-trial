...
from cpg_reconciler.drift.types import DriftDirection, DriftSignal
...
class DriftAnalyzer:
    ...
    constructor ensures ``cpg_reconciler.drift.strategies`` is imported so all
    ...
    def __init__(
        ...
        if strategies is not None:
            ...
            import cpg_reconciler.drift.strategies  # noqa: F401 — registers into DEFAULT_STRATEGIES
            import cpg_reconciler.drift.markov  # noqa: F401 — registers markov_strategy
